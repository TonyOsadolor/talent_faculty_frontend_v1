...
const Profile = () => {
  ...
  const handleSave = () => {
    ...
    <div className="min-h-screen bg-white">
      {/* ================= HEADER ================= */}
      <div className="flex items-start justify-between px-6 md:px-8 lg:px-9 pt-8 pb-7">
        {/* Page Title */}
        <div>
...
<section className="rounded-[24px] border border-[#e9e9e9] bg-white px-5 py-5">
  ...
  <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
    ...
    <div>
      ...
      <input
        ...
        readOnly={!isEditing}
        className={`h-[48px] w-full rounded-[8px] border bg-white px-5 text-[15px] outline-none transition ${
          isEditing
    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          onChange={handleChange}
          readOnly={!isEditing}
          className={`h-[48px] w-full rounded-[8px] border bg-white pl-[52px] pr-5 text-[15px] outline-none transition ${
            isEditing
              ? "border-[#057834] text-[#222]"
              : "border-[#d3d3d3] text-[#cfcfcf]"
          }`}
  ...
  <div className="mt-5">
    ...
    <textarea
      ...
      onChange={handleChange}
      readOnly={!isEditing}
      className={`h-[155px] w-full resize-none rounded-[8px] border bg-white px-5 py-4 text-[15px] outline-none transition ${
        isEditing
          ? "border-[#057834] text-[#222]"
          : "border-[#d3d3d3] text-[#cfcfcf]"
      }`}
